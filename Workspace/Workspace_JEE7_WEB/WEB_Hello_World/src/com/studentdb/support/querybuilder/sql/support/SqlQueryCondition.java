 ...
 * 
 */
package com.studentdb.support.querybuilder.sql.support;
...
public class SqlQueryCondition {
	...
	/**
	 * @param conditionIsJoiner
	 *            the conditionIsJoiner to set
	 */
	...
	public String getSqlString() {
		if (isConditionJoiner())
			...
			return new StringBuilder(columnName + operator).append(SqlQueryBuilder.getQueryAppendableValue(getValue()))
					.toString();
