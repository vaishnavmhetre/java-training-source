...
<jsp:useBean id="sampleAnimalTypeServiceProxyid" scope="session" class="com.categories.service.AnimalTypeServiceProxy" />
<%
...
case 10:
        gotMethod = true;
        com.categories.service.AnimalTypeService getAnimalTypeService10mtemp = sampleAnimalTypeServiceProxyid.getAnimalTypeService();
