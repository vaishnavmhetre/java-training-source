...
public class MessageDao extends Dao {
	...
	public List<Message> getUnreadMessagesForUserId(int userId) throws SQLException {
		...
		List<SqlQueryCondition> conditions = Arrays.asList(
				new SqlQueryCondition("read_at", SqlQueryBuilderFlags.CONDITION_EQUAL, SqlQueryBuilderFlags.NULL),
				new SqlQueryCondition(SqlQueryBuilderFlags.CONDITION_JOINER_AND), new SqlQueryCondition("("),
				new SqlQueryCondition("receiver_id", SqlQueryBuilderFlags.CONDITION_EQUAL, userId),
				new SqlQueryCondition(SqlQueryBuilderFlags.CONDITION_JOINER_OR),
				new SqlQueryCondition("sender_id", SqlQueryBuilderFlags.CONDITION_EQUAL, userId),
	...
	public int createMesssageBetweenUser(User sender, User receiver, Message message)
			throws InvalidQueryBuilderParameter, SQLException {
	...
	public int markAsRead(Message message) throws InvalidQueryBuilderParameter, SQLException {
		...
		List<SqlQueryCondition> conditions = Arrays
				.asList(new SqlQueryCondition("id", SqlQueryBuilderFlags.CONDITION_EQUAL, message.getId()));
